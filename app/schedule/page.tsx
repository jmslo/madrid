...
const WEEKS = [
  { num: 1, dates: 'April 1 – 7',  title: 'Arrive, Settle, Launch',               color: 'var(--terracotta)', vibe: 'Your most energetic week — no stims, no social obligations, friends away. Use it hard. This is your setup week: apps deployed, routines established, Semana Santa absorbed, AI project brewing.', focus: ['Deploy both apps', 'Dental + skin appts', 'Semana Santa', 'Website architecture'] },
  { num: 2, dates: 'April 8 – 14', title: 'Stims Begin · Build Momentum',          color: 'var(--sage)',       vibe: 'Stims start this week — Tambre appointments every 2–3 days. Your most ambitious build week. Friends return from Easter. Best friend arrives Tuesday the 14th.',                                  focus: ['AI project format', 'Website first draft', 'Malasaña thrift day', 'Best friend arrives Apr 14'] },
  { num: 3, dates: 'April 15 – 19', title: 'Peak Stims · Best Friend · Go Gentle', color: 'var(--gold)',       vibe: 'The hardest physical week — bloating and fatigue peak. But your best friend is here for most of it, which changes everything. Plan beautiful evenings together and a gentle Sunday morning before she flies home — which is also retrieval day.', focus: ['AI project artifact', 'Flamenco', 'Best friend week', 'Retrieval Apr 19'] },
  { num: 4, dates: 'April 20 – 22', title: 'Rest, Reflect, Receive',               color: 'var(--recovery)',   vibe: 'Three gentle days. Don\'t think of this as dead time — think of it as integration. You\'ve built three things, read three books, seen Madrid slowly and well. This is the exhale.',               focus: ['Reflection', 'Finish books', 'Gentle walks', 'Depart proud'] },
]
